...
def calcular_estadisticas():
    ...
    if not archivos_csv:
        ...
        with open(archivo, "r", encoding="utf-8") as f:
            ...
            if n_columna < 0 or n_columna >= len(encabezados):
                ...
                if datos:
                    ...
                    print("=================================")
                    print(f"Estadísticas de: {nom_columna}")
                    print("=================================")
...
def graficar_columna():
    ...
    if not archivos_csv:
        ...
        if not filas:
            ...
            n_columna = int(input("Seleccione el número de columna para gráficar dispersión: "))
            nom_columna = encabezados[n_columna]
            ...
            if datos:
                ...
                plt.title(f'Gráfica de dispersión - {nom_columna}', fontsize=14, fontweight='bold')
                plt.xlabel('Número de fila', fontsize=12)
                plt.ylabel(nom_columna, fontsize=12)
                plt.grid(alpha=0.3, linestyle='--')
                plt.tight_layout()
                plt.show()

                print("=================================================")
                print("Seleccione una columna para el graficar en barras")
                print("=================================================")
                
                col_bar = int(input("Seleccione el número de columna: "))
                nom_columna_bar = encabezados[col_bar]
                ...
                if valores_bar:
                    ...
                    plt.title(f'Histograma - {nom_columna_bar}', fontsize=14, fontweight='bold')
                    plt.xlabel(nom_columna_bar, fontsize=12)
